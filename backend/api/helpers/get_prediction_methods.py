...
def get_prediction_methods():
    return [
            ...
            },
            {
                ...
                "description": "a linear regression model trained on season long statistics with advanced data",
                "path": "api/linear"
            },
            {
                "name": "Logistic Regression Model",
                "description": "a logistic regression model trained on season long statistics with advanced data",
                "path": "api/logistic"
            }
        ]